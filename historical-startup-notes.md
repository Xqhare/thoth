...
I have now spend over a year (started in mid 2024, now its Jan of 2026 (quick note, started work on: 2026-06-24)), on and off, learning about [Unicode](https://www.unicode.org/versions/Unicode17.0.0/core-spec/chapter-3/#G52443), and now I understand why everybody warns about doing this.
...
3. The rules `GB9c` through to `GB13` will be ignored.
